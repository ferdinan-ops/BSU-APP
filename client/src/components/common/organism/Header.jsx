  ...
  return (
    <header className="sticky inset-x-0 top-0 z-[999] flex h-20 items-center border-b border-slate-200 bg-white font-source text-font md:h-24">
      <div className="container mx-auto flex items-center justify-between gap-16 px-[18px] xl:px-0">
        ...
        <div
          className={`fixed left-[18px] right-[18px] flex items-center gap-4 rounded-lg border-2 border-slate-200 bg-white px-4 py-2 transition-all focus-within:border-primary xl:static xl:w-full xl:translate-y-0 xl:gap-5 xl:px-6 xl:py-3 ${
